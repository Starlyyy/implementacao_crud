                        ...
                        <form action="<?= URL_BASE ?>/modulos/salvar" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="descricao" name="descricao" value="<?= $modulo['descricao'] ?? '' ?>">
